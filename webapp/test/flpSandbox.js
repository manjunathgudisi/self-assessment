		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#easelfassessment-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"easelfassessment-display": {
								"semanticObject": "easelfassessment",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=easelfassessment",
									"url": sap.ui.require.toUrl("easelfassessment")
								}
							}
						}
					}
